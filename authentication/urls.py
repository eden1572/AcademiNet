...
from blog.views import PostList,PostList_editor,PostList_admin, some_viewstudent,get_list_for_editor,get_list_for_admin,some_viewstudent,some_viewadmin,some_vieweditor
from blog.views import editorspost
from messaging.views import create_message, create_message_editor, create_message_admin
...
urlpatterns = [
    ...
    path('student-rights/', editorspost, name='student-rights'),
    ...
    path('contact_us/', create_message, name='contact_us'),
    path('contact_us_editor/', create_message_editor, name='contact_us_editor'),
    path('contact_us_admin/', create_message_admin, name='contact_us_admin'),

    #ניתוב לעמוד "בלוג" עבור כל משתמש באתר
    path('blog_page/', PostList.as_view(), name='blog_page'),
    path('blog_page_editor/',PostList_editor.as_view(), name='blog_page_editor'),
    path('blog_page_admin/',PostList_admin.as_view(), name='blog_page_admin'),
  ...
  #נשלחת הודעת מייל עם הנושא והטקסט הרלוונטי
   path('password-reset/', 
    ...
    #לדבר עם עדן בנוגע לשינוי
    path('student-profile/', some_viewstudent, name='student_profile'),
    path('editor-profile/', some_vieweditor, name='editor_profile'),
    path('admin-profile/', some_viewadmin, name='admin_profile'),
